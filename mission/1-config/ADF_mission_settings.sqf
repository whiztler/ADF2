...
*********************************************************************************
Use this script to configure framework settings.
For more information see the framework documentation. 'ADF\documentation'
*********************************************************************************/

ADF__ERPT("executing ADF_mission_settings.sqf");
...
_ADF_preset = "DEFAULT"; // pre-defined call sign/radio freq presets. [DEFAULT / SHAPE / NOPRYL / CUSTOM]. Configure the presets in 'ADF\modules\ADF_fnc_presets.sqf'
_ADF_briefingName = "ADF_briefing.sqf"; // Name of the briefing file (in mission\2.briefing)
...
ADF_tpl_version = "2.00"; // ADF version DO NOT EDIT
_ADF_devBuild = "Alpha"; // [Alpha/Beta/Production] DO NOT EDIT
