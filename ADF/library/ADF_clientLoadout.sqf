...
// Two Sierra exit
if (ADF_clanName == "TWO SIERRA") exitWith {player execVM "ADF\modules\ADF_fnc_Loadout2S.sqf";};
...
if ((_ADF_unitFaction == "BLU_F") && _ADF_customLoadout_MOD) exitWith { // BLUFOR: Custom loadout = true
	...
	call compile preprocessFileLineNumbers "ADF\modules\ADF_fnc_Loadoutwest.sqf";
