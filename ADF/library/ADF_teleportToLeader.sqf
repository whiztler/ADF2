...
Place an object (flag pole, vehicle, etc.) and add the following to the init field:
this addAction ["<t align='left' color='#E4F2AA'>Teleport to Troop Leader</t>", "ADF\library\ADF_teleportToLeader.sqf",[], 5, true, false,"", ""]; this allowDamage false;
*********************************************************************************/

#include "\ADF\ADF_macros.hpp"
ADF__ERPT("ADF_teleportToLeader.sqf");

// Init
ADF__P2(_o,_u);
private _l = leader (group _u);
private _p = getPosATL _l;
private _d = getDirVisual _l;
