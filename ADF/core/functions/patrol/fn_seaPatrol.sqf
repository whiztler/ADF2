...
**********************************************************************************
This is an patrol function for boats. You can use it on pre-existing crewed
boats.
...
Example for scripted crewed boats:
...
Example for crew editor placed boats:
[group this, position this, 1000, 5, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_seaPatrol;
...
ADF__ERPT("ADF_fnc_seaPatrol.sqf");
...
ADF__CHKPOSA(_p);
private _a = [_g, _p, _r, _t, _b, _m, _s, _f, _cr, "sea", false];
