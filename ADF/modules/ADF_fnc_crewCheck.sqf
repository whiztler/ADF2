...
Configure in 'ADF\library\ADF_crewCheck.sqf'
*********************************************************************************/
...
ADF_CC_addEH = {
	(_this select 0) addEventHandler ["GetIn", {
		...
		private _ADF_CC_airRestrict 	= true;
		private _ADF_CC_uID			= owner _ADF_CC_unit;
		private _ADF_CC_objectType		= typeOf _ADF_CC_object;
		private _ADF_CC_objectName 	= getText(configFile >> "CfgVehicles" >> _ADF_CC_objectType >> "displayName");
...
ADF_CC_checkTurret = {
	...
	private _ADF_CC_inTurret 		= !isNull (_ADF_CC_object turretUnit ((allTurrets [_ADF_CC_object, false]) select 0));
	private _ADF_CC_unitCmd		= commander _ADF_CC_object == _ADF_CC_unit;
	private _ADF_CC_TurretActive	= _ADF_CC_inTurret || _ADF_CC_unitCmd;
	_ADF_CC_TurretActive
};

ADF_CC_checkDriver = {
	params ["_ADF_CC_unit", "_ADF_CC_object"];
	private _ADF_CC_unitDriver	= (driver _ADF_CC_object == _ADF_CC_unit);
	_ADF_CC_unitDriver
};
